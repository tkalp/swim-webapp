              ...
              <div className="bg-linear-to-br from-slate-900 to-slate-800 border-2 border-cyan-500/20 rounded-2xl overflow-hidden shadow-xl relative">
                ...
                <div className="sticky top-0 z-10 bg-slate-800/98 backdrop-blur-md border-b-2 border-cyan-500/20 shadow-lg">
                  <div className="grid grid-cols-12 gap-4 px-6 py-3 text-xs font-bold text-slate-400 uppercase tracking-wider">
                    ...
                    <div className={comparisonMode ? "col-span-2" : "col-span-2"}>Rank</div>
                    <div className={comparisonMode ? "col-span-3" : "col-span-3"}>Date</div>
                    <div className={comparisonMode ? "col-span-2" : "col-span-3"}>Time</div>
                    <div className={comparisonMode ? "col-span-2" : "col-span-2"}>Splits</div>
                        ...
                        >
                          ...
                          <div
                            className={`
                              ...
                              ${isBest ? 'bg-linear-to-r from-cyan-500/10 to-blue-500/10 border-cyan-500/30' : ''}
                          ...
                          >
                            ...
                            {/* Rank */}
                            <div className={comparisonMode ? "col-span-2" : "col-span-2"}>
                              <div className="flex items-center gap-2">
                                {index === 0 ? (
                                  <div className="flex items-center gap-2">
                                    ...
                                    <div className="flex flex-col">
                                      <span className="text-[10px] font-bold text-yellow-400 uppercase tracking-wide">Best</span>
                                      <span className="text-xs text-yellow-400/70 font-semibold">#{index + 1}</span>
                                    </div>
                                  </div>
                                ) : index === 1 ? (
                                  <div className="flex items-center gap-2">
                            ...
                            {/* Date */}
                            <div className={comparisonMode ? "col-span-3" : "col-span-3"}>
                              <div className="flex items-center gap-2">
                            ...
                            {/* Time */}
                            <div className={comparisonMode ? "col-span-2" : "col-span-3"}>
                              <div className="flex items-center gap-2">
                                <Clock
                                  size={16}
                                  className={isBest ? "text-cyan-400" : "text-slate-500"}
                                />
                                <span
                                      ...
                                      `}>
                                        ...
                                        {deltaInfo && !deltaInfo.isBest && (
                                          <div className={`flex items-center gap-1 text-[10px] font-mono font-semibold ${
                                            deltaInfo.delta < 0 ? 'text-green-400' : 'text-red-400'
                                          }`}>
                                            {deltaInfo.delta < 0 ? (
