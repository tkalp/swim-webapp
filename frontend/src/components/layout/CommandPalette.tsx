      ...
      <div className="fixed top-[15vh] left-1/2 -translate-x-1/2 w-full max-w-2xl z-201 px-4 animate-in fade-in slide-in-from-top-4 duration-200">
        <div className="bg-background-elevated border border-border/60 rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div className="flex items-center gap-3 px-4 py-4 border-b border-border/40">
            ...
            />
            <kbd className="hidden sm:inline-block px-2 py-1 text-xs text-text-muted bg-background-secondary/60 rounded border border-border/40 font-mono">
              ESC
            </kbd>
          </div>
                      ...
                      <button
                        ...
                        className={`
                          ...
                          ${isSelected 
                            ...
                            : 'border border-transparent hover:bg-background-secondary/60'
                          }
                        `}
                      >
                        <div className={`
                          p-2 rounded-lg shrink-0 transition-colors
                          ${isSelected ? 'bg-primary/20' : 'bg-background-secondary/60'}
                        `}>
                          <Icon size={16} className={isSelected ? 'text-primary' : 'text-text-secondary'} />
                        </div>
          ...
          {/* Footer */}
          <div className="border-t border-border/40 px-4 py-3 bg-background-secondary/30">
            <div className="flex items-center justify-between text-xs text-text-muted">
              <div className="flex items-center gap-4">
                <span className="flex items-center gap-1.5">
                  <kbd className="px-1.5 py-0.5 bg-background-elevated rounded border border-border/40 font-mono">↑↓</kbd>
                  Navigate
                </span>
                <span className="flex items-center gap-1.5">
                  <kbd className="px-1.5 py-0.5 bg-background-elevated rounded border border-border/40 font-mono">↵</kbd>
              ...
              <span className="hidden sm:inline">
                Press <kbd className="px-1.5 py-0.5 bg-background-elevated rounded border border-border/40 font-mono">Cmd+K</kbd> to open
              </span>
            </div>
          </div>
        </div>
