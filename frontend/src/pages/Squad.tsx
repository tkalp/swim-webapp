...
export default function SquadPage() {
  ...
  const tab = (params.get('tab') as TabKey) || 'swimmers'
  ...
  return (
    <div className="flex flex-col h-screen overflow-hidden">
      {/* Header */}
      <header className="shrink-0 z-100 bg-background-elevated/95 backdrop-blur-xl border-b border-border shadow-lg">
        <div className="max-w-[1800px] mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-5">
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            >
              ...
              <span className="hidden md:inline text-lg font-bold bg-linear-to-r from-primary-dark via-primary to-accent bg-clip-text text-transparent">
                aquilus
              </span>
            </Link>
            ...
            <div className="flex items-center gap-2.5">
              <div className="w-8 h-8 rounded-lg bg-linear-to-br from-primary/30 via-primary/40 to-accent/30 border border-primary/40 flex items-center justify-center shadow-md">
